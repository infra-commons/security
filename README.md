...
| Workflow | Purpose |
|---|---|
| `capture-findings-reusable.yml` | Post-merge capture ([two sources](#capture-findings-reads-both-pr-time-reviewers)): CRITICAL/HIGH filed as individual GitHub Issues, MEDIUM/LOW rolled into one digest issue per repo |
